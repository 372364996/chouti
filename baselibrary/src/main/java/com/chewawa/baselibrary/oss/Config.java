...
public class Config {
    ...
    public static final String STS_SERVER_URL = "/api/OSS/GetIsEncrypToken";//STS 地址
    public static final String STS_UPLOAD_URL = "/api/OSS/GetFileName";//STS 上传图片地址

    public static final String STS_TOKEN_EXPIRATION = "expiration";
    public static final String STS_TOKEN_DATA = "sts_token_data";
