 ...
 * 版本： v1.0<br>
 */
public class CommonSignInterceptor extends BaseCustomDynamicInterceptor<CommonSignInterceptor> {
    private String sourceCode;
    public CommonSignInterceptor(String sourceCode){
    ...
    public TreeMap<String, String> dynamic(TreeMap<String, String> dynamicMap) {
        ...
        dynamicMap.put(ComParamContact.Common.ACCESSTOKEN, BaseCommonUtil.getToken());
