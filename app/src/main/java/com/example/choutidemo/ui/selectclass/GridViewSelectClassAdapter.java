...
public class GridViewSelectClassAdapter extends BaseAdapter {
    private Context context;
  private   List<Map<String, Object>> data;


    public GridViewSelectClassAdapter(Context context, List<Map<String, Object>> data) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv = convertView.findViewById(R.id.id);
