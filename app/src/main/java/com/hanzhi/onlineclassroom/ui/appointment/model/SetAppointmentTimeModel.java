 ...
 */
public class SetAppointmentTimeModel extends BaseModelImpl implements SetAppointmentTimeContract.Model {
    @Override
    public void getTabList(SetAppointmentTimeContract.OnGetTabListListener listener) {
